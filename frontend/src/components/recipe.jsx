...
class Recipe extends React.Component {
  ...
  componentDidMount() {
    ...
    for (i = 0; i < 20; i++) {
      if (
        this.props.location.state.recipe[queryKeys[i + 9]] &&
        this.props.location.state.recipe[queryKeys[i + 29]]
      ) {
        if (
          this.props.location.state.recipe[queryKeys[i + 9]] !== "" ||
          this.props.location.state.recipe[queryKeys[i + 29]] !== ""
          ...
          ingredient_items[i] = {
            measurement: this.props.location.state.recipe[queryKeys[i + 29]],
        ...
        <div class="Recipe-component">
          <div class="container-fluid content">
            <div class="row">
              ...
              <div class="col-md-4">
                <img
                  class="img-fluid img-rounded center-block d-block mx-auto"
                  src={this.props.location.state.recipe.strMealThumb}
                  alt={this.props.location.state.recipe.strMeal}
                />
              </div>
              <div class="col-md-4"></div>
            </div>
